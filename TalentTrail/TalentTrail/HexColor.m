...
{
    return [self colorWithHexString:@"F3AB1C"];
}

+(UIColor *) talentTrailBlue
{
    return [self colorWithHexString:@"38A4DC"];
}

+(UIColor *) talentTrailGreen
{
    return [self colorWithHexString:@"49B755"];
}
+(UIColor *) talentTrailRed
{
    return [self colorWithHexString:@"DB3A3A"];
}
+(UIColor *) talentTrailPurple
{
    return [self colorWithHexString:@"8351A0"];
}
